...
(function ($) {
	...
	document.addEventListener('DOMContentLoaded', () => {
		...
		const contacts = {
			...
			number: 'Number: +995595891894',
			github: 'GitHub: https://github.com/noteMASTER11/',
			linkedin: 'LinkedIn: https://www.linkedin.com/in/daniil-derbenyov/',
		};
		...
		btn.onclick = function () {
			...
			<p>${contacts.github} <button class="copyButton" data-copy="${contacts.github}"><i class="fas fa-copy"></i></button></p>
			<p>${contacts.linkedin} <button class="copyButton" data-copy="${contacts.linkedin}"><i class="fas fa-copy"></i></button></p>
        ...
        `;
			...
			document.getElementById('copyAllButton').onclick = function () {
				...
				this.innerHTML = '<i class="fas fa-check copied"></i>';
			};
